...
<title>Accessibility Guidelines - WCAG 2.2 AAA Compliance</title>
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Learn about web accessibility and WCAG 2.2 AAA compliance">
    <title>Accessibility Guidelines - WCAG 2.2 AAA</title>
    <link rel="stylesheet" href="styles.css">
    <link rel="icon" href="favicon.ico">
  </head>
  <body>
